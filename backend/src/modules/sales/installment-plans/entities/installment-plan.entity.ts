...
import { InstallmentInterestType, InstallmentPlanStatus } from '../../../../entities/enums';
...
export class InstallmentPlan extends BaseEntity {
  ...
  @OneToMany(() => InstallmentPlanLine, (line) => line.installmentPlan, { cascade: true })
...
export class InstallmentPlanLine extends BaseEntity {
  ...
  @ManyToOne(() => InstallmentPlan, (plan) => plan.lines, { onDelete: 'CASCADE' })
